...
if (substr_count($content, '[vc_single_image')) {
	$content = str_replace('[vc_single_image', '[vc_single_image col_width="' . $width_media . '"', $content);
}
...
if (substr_count($content, '[uncode_slider')) {
	...
	$content = str_replace('[uncode_slider','[uncode_slider'.$slider_padding.' style="'.$style.'"', $content);
}
