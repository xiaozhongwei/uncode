...
if ($show_title)
{
	...
	//$title_content .= '<div class="post-title-wrapper">';
		$title_content .= '<div class="mkdf-events-single-main-info clearfix">';
			$title_content .= '<div class="mkdf-events-single-date-holder">';
				$title_content .= '<div class="mkdf-events-single-date-inner">';
					$title_content .= '<span class="mkdf-events-single-date-day">';
						$title_content .= tribe_get_start_date(null, true, 'd');
					$title_content .= '</span>';

					$title_content .= '<span class="mkdf-events-single-date-month">';
						$title_content .= tribe_get_start_date(null, true, 'M');
					$title_content .= '</span>';
				$title_content .= '</div>';
			$title_content .= '</div>';

			$title_content .= '<div class="mkdf-events-single-title-holder">';
				$title_content .= '<h3 class="mkdf-events-single-title post-title">'. get_the_title().'</h3>';
				$title_content .= '<div class="mkdf-events-single-date">';
					$title_content .= '<span class="mkdf-events-single-info-icon">';
						$title_content .= '<span class="fa fa-clock-o"></span>';
					$title_content .= '</span>';
					$title_content .= tribe_events_event_schedule_details($event_id);
				$title_content .= '</div>';
				if(tribe_get_cost($event_id)) {
					$title_content .= '<div class="mkdf-events-single-cost">';
					$title_content .= tribe_get_cost(null, true);
					$title_content .= '</div>';
				}
			$title_content .= '</div>';
		$title_content .= '</div>';

		//$title_content .= '<h1 class="post-title">' . get_the_title() . '</h1>';
	//$title_content .= '</div>';
...
if ($layout === 'sidebar_right' || $layout === 'sidebar_left')
{
	...
	$the_notices = tribe_the_notices(false);
...
?>
	<div class="mkdf-events-single-meta">
		...
		<h3><?php esc_html_e('Event Details', 'uncode'); ?></h3>

		<div class="mkdf-events-single-meta-holder row">
			<div class="col-4">
				<div class="mkdf-events-single-meta-item">
					<span class="mkdf-events-single-meta-icon">
						<span class="fa fa-calendar"></span>
					</span>
					<span class="mkdf-events-single-meta-label"><?php esc_html_e('Date:', 'uncode'); ?></span>
				...
				<div class="mkdf-events-single-meta-item">
					...
					<span class="mkdf-events-single-meta-label"><?php esc_html_e('Time:', 'uncode'); ?></span>
					<span class="mkdf-events-single-meta-value">
				...
				<?php if(tribe_has_venue()) : ?>
					<div class="mkdf-events-single-meta-item">
						...
						<span class="mkdf-events-single-meta-label"><?php esc_html_e('Venue', 'uncode'); ?></span>
						<span class="mkdf-events-single-meta-value">
					...
					<?php if(tribe_address_exists()) : ?>
						<div class="mkdf-events-single-meta-item">
							...
							<span class="mkdf-events-single-meta-label"><?php esc_html_e('Address:', 'uncode'); ?></span>
							<span class="mkdf-events-single-meta-value">
			...
			<div class="col-4">
				<?php if(tribe_has_organizer()) : ?>
					<div class="mkdf-events-single-meta-item">
						...
						<span class="mkdf-events-single-meta-label"><?php esc_html_e('Organizer Name:', 'uncode'); ?></span>
						<span class="mkdf-events-single-meta-value">
				...
				<?php if(tribe_get_organizer_phone()) : ?>
					<div class="mkdf-events-single-meta-item">
						...
						<span class="mkdf-events-single-meta-label"><?php esc_html_e('Phone:', 'uncode'); ?></span>
						<span class="mkdf-events-single-meta-value">
				...
				<?php if(tribe_get_organizer_email()) : ?>
					<div class="mkdf-events-single-meta-item">
						...
						<span class="mkdf-events-single-meta-label"><?php esc_html_e('Email:', 'uncode'); ?></span>
						<span class="mkdf-events-single-meta-value">
				...
				<?php if(tribe_get_organizer_website_link()) : ?>
					<div class="mkdf-events-single-meta-item">
						...
						<span class="mkdf-events-single-meta-label"><?php esc_html_e('Website:', 'uncode'); ?></span>
						<span class="mkdf-events-single-meta-value">
...
<?php
	...
	$the_content = '<div class="post-content style-' . $style . $main_classes . '">' . $the_notices.$the_content.$meta_content . '</div>';
...
$navigation_index = wpml_get_object_id($navigation_index);
	}
	if ($navigation_index !== '')
	{
...
?>
<article id="post-<?php echo get_the_ID();?>" class="tribe-events-single mkdf-tribe-events-single <?php echo implode(' ', get_post_class('page-body' . $bg_color));?>">
