...
$topbar_bg_color = $uncode_option['_uncode_topbar_bg_color'];
$topbar_color = $uncode_option['_uncode_topbar_color'];

$topbar_font_size = $uncode_option['_uncode_topbar_font_size'];
$topbar_font_family = $uncode_option['_uncode_topbar_font_family'];
$topbar_font_family_zh = $uncode_option['_uncode_topbar_font_family_zh'];
$topbar_font_weight = $uncode_option['_uncode_topbar_font_weight'];
...
$font_family_base_zh = $uncode_option['_uncode_body_font_family_zh'];
$font_family_ui_zh = $uncode_option['_uncode_ui_font_family_zh'];
$font_family_menu_zh = $uncode_option['_uncode_menu_font_family_zh'];
$font_family_headings_zh = $uncode_option['_uncode_heading_font_family_zh'];
$font_family_btn_zh = $uncode_option['_uncode_buttons_font_family_zh'];
...
foreach ($front_background_colors as $key => $value)
{
	...
	if ($key === $topbar_bg_color) $topbar_bg_color = $value;
...
if (isset($uncode_option['_uncode_font_groups'])) {
	...
	if (!empty($fonts) && is_array($fonts)) {
		foreach ($fonts as $key => $value) {
			...
			if ($font_class === $topbar_font_family) $topbar_font_family = $font_name;
