...
<div class="wrap about-wrap uncode-wrap">
    ...
    <?php
			printf( '<a href="%s" class="nav-tab nav-tab-active">%s</a>', admin_url('admin.php?page=wku-options'), esc_html__( "System Status", "uncode" ) );
			// printf( '<a href="%s" class="nav-tab">%s</a>', admin_url( 'admin.php?page=one-click-demo' ), esc_html__( "Install Demo", "uncode" ) );
			printf( '<a href="%s" class="nav-tab">%s</a>', admin_url('admin.php?page=wku-options'), esc_html__( "Theme Options", "uncode" ) );
