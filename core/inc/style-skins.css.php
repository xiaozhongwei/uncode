...
[lang="zh-hans"] body {
  font-family: <?php echo $font_family_base_zh; ?>;
}
body,
...
[lang="zh-hans"] .font-ui-fixed,
[lang="zh-hans"] .post-info,
[lang="zh-hans"] .widget-container .widget-title,
[lang="zh-hans"] #comments .comments-title,
[lang="zh-hans"] #respond .comments-title,
[lang="zh-hans"] #comments #reply-title,
[lang="zh-hans"] #respond #reply-title,
[lang="zh-hans"] .uncode-share h6,
[lang="zh-hans"] .woocommerce div.product .wootabs .tab-pane:not(.tab-vcomposer) .product-tab-title,
[lang="zh-hans"] .woocommerce #content div.product .wootabs .tab-pane:not(.tab-vcomposer) .product-tab-title,
[lang="zh-hans"] .woocommerce #reviews .woocomments .woocomments-title,
[lang="zh-hans"] .woocommerce .products.related .related-title,
[lang="zh-hans"] .woocommerce #review_form #respond #reply-title,
[lang="zh-hans"] .font-ui,
[lang="zh-hans"] .plan .plan-title > h3,
[lang="zh-hans"] .plan .plan-price .price,
[lang="zh-hans"] #main-logo .text-logo,
[lang="zh-hans"] .isotope-filters ul.menu-smart > li > span > a,
[lang="zh-hans"] .comment-content .comment-reply-link span,
[lang="zh-hans"] .comment-content .comment-reply-link {
  font-family: <?php echo $font_family_ui_zh; ?>;
}
/* #Body-color-light */
.style-light {
...
[lang="zh-hans"] h5,
[lang="zh-hans"] h6,
[lang="zh-hans"] .tmb .t-entry .t-entry-cat,
[lang="zh-hans"] .tmb .t-entry .t-entry-title,
[lang="zh-hans"] .tmb-woocommerce.tmb .t-entry-visual .add-to-cart-overlay a,
[lang="zh-hans"] .author-details-data .author-heading span,
[lang="zh-hans"] .vc_progress_bar .vc_progress_label,
[lang="zh-hans"] .vc_pie_chart .vc_pie_chart_value,
[lang="zh-hans"] ul.dwls_search_results .daves-wordpress-live-search_title .search-title,
[lang="zh-hans"] .woocommerce div.product span.price,
[lang="zh-hans"] .woocommerce #content div.product span.price,
[lang="zh-hans"] .woocommerce div.product p.price,
[lang="zh-hans"] .woocommerce #content div.product p.price,
[lang="zh-hans"] .woocommerce div.product form.cart .group_table .price,
[lang="zh-hans"] .woocommerce #content div.product form.cart .group_table .price,
[lang="zh-hans"] .woocommerce div.product form.cart .group_table .price *,
[lang="zh-hans"] .woocommerce #content div.product form.cart .group_table .price *,
[lang="zh-hans"] span.price,
[lang="zh-hans"] p.price,
[lang="zh-hans"] p .thank-you {
  font-family: <?php echo $font_family_headings_zh; ?>;
}
/* #Headings-color */
...
[lang="zh-hans"] .buttons-style,
[lang="zh-hans"] input[type="submit"],
[lang="zh-hans"] input[type="reset"],
[lang="zh-hans"] input[type="button"],
[lang="zh-hans"] button[type="submit"],
[lang="zh-hans"] .btn,
[lang="zh-hans"] .btn-link,
[lang="zh-hans"] .nav-tabs,
[lang="zh-hans"] .panel-title > a span,
[lang="zh-hans"] .search_footer,
[lang="zh-hans"] .wc-forward,
[lang="zh-hans"] .wc-forward a {
  font-family: <?php echo $font_family_btn_zh; ?> !important;
}
/* #Button-weight */
.buttons-weight,
.woocommerce span.onsale,
...
[lang="zh-hans"] .font-family-menu,
[lang="zh-hans"] .menu-container ul.menu-smart a {
  font-family: <?php echo $font_family_menu_zh; ?>;
}
@media (max-width: 959px) {
  ...
  [lang="zh-hans"] .menu-primary ul.menu-smart a {
    font-family: <?php echo $font_family_menu_zh; ?>;
  }
}
/* #Font-size-menu */
...
.top-menu .menu-item, .top-menu a {
  font-family: <?php echo esc_html($topbar_font_family); ?>;
  font-weight: <?php echo esc_html($topbar_font_weight); ?>;
  color: <?php echo esc_html($topbar_color); ?>;
  line-height: 55px;
  font-size: <?php echo esc_html($topbar_font_size); ?>px;
}
[lang="zh-hans"] .top-menu .menu-item, .top-menu a {
  font-family: <?php echo $topbar_font_family_zh; ?>;
}
/*
----------------------------------------------------------
...
--------------------------------------------------------
*/
.uncode-subnav .current_page_item a {
  color: <?php echo esc_html($cs_accent_color); ?>;
}
