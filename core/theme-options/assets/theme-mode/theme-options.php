...
function custom_theme_options()
{
	...
	$zh_fonts = array(
		array(
			'value' => "'Microsoft YaHei', '微软雅黑', 'STHeiti Light', '华文细黑'",
			'label' => "微软雅黑"
		),
		array(
			'value' => "'SimHei','黑体', 'STHeiti', '华文黑体'",
			'label' => "黑体"
		),
		array(
			'value' => "'SimSun','宋体', 'STSong', '华文宋体'",
			'label' => "宋体"
		),
		array(
			'value' => "'KaiTi_GB2312','楷体_GB2312', 'STKaiti', '华文楷体'",
			'label' => "楷体"
		),
	);

	$zh_fonts_std = "'Microsoft YaHei', '微软雅黑', 'STHeiti Light', '华文细黑'";
	...
	$custom_settings = array(
		'sections' => array(
			...
			array(
				'id' => 'uncode_topbar_section',
				'title' => '<i class="fa fa-bookmark"></i> ' . esc_html__('Topbar', 'uncode')
			),
			array(
			...
			array(
				'id' => 'uncode_tribe_events_section',
				'title' => '<span class="smaller"><i class="fa fa-paper"></i> ' . esc_html__('Event', 'uncode') . '</span>'
			) ,
			array(
				'id' => 'uncode_club_section',
				'title' => '<span class="smaller"><i class="fa fa-paper"></i> ' . esc_html__('Club', 'uncode') . '</span>'
			) ,
			array(
			...
			array(
				'id' => 'uncode_tribe_events_index_section',
				'title' => '<span class="smaller"><i class="fa fa-archive2"></i> ' . esc_html__('Events', 'uncode') . '</span>'
			) ,
			array(
				'id' => 'uncode_club_index_section',
				'title' => '<span class="smaller"><i class="fa fa-archive2"></i> ' . esc_html__('Clubs', 'uncode') . '</span>'
			) ,
			array(
			...
			array(
				'id' => 'uncode_notification_section',
				'title' => '<i class="fa fa-bell-o"></i> ' . esc_html__('Notification', 'uncode')
			) ,
			array(
		...
		'settings' => array(
			...
			array(
				'id' => '_uncode_topbar_switch',
				'label' => esc_html__('Show Topbar', 'uncode') ,
				'desc' => esc_html__('Activate to show the topbar.', 'uncode') ,
				'std' => 'on',
				'type' => 'on-off',
				'section' => 'uncode_topbar_section',
			) ,
			array(
			...
			array(
				'id' => '_uncode_menu_no_third',
				'label' => esc_html__('Hide third menu', 'uncode') ,
				'desc' => esc_html__('Activate to hide the third menu.', 'uncode') ,
				'std' => 'off',
				'type' => 'on-off',
				'section' => 'uncode_topbar_section',
			) ,
			...
			//  Club Single		///
			//////////////////////
			str_replace('%section%', 'club', $menu_section_title),
			str_replace('%section%', 'club', $menu),
			str_replace('%section%', 'club', $menu_width),
			str_replace('%section%', 'club', $menu_opaque),
			str_replace('%section%', 'club', $header_section_title),
			str_replace('%section%', 'club', run_array_to($header_type, 'std', 'header_basic')),
			str_replace('%section%', 'club', $header_uncode_block),
			str_replace('%section%', 'club', $header_revslider),
			str_replace('%section%', 'club', $header_layerslider),

			str_replace('%section%', 'club', $header_width),
			str_replace('%section%', 'club', $header_height),
			str_replace('%section%', 'club', $header_min_height),
			str_replace('%section%', 'club', $header_title),
			str_replace('%section%', 'club', $header_style),
			str_replace('%section%', 'club', $header_content_width),
			str_replace('%section%', 'club', $header_custom_width),
			str_replace('%section%', 'club', $header_align),
			str_replace('%section%', 'club', $header_position),
			str_replace('%section%', 'club', $header_title_font),
			str_replace('%section%', 'club', $header_title_size),
			str_replace('%section%', 'club', $header_title_height),
			str_replace('%section%', 'club', $header_title_spacing),
			str_replace('%section%', 'club', $header_title_weight),
			str_replace('%section%', 'club', $header_title_transform),
			str_replace('%section%', 'club', $header_title_italic),
			str_replace('%section%', 'club', $header_text_animation),
			str_replace('%section%', 'club', $header_animation_speed),
			str_replace('%section%', 'club', $header_animation_delay),
			str_replace('%section%', 'club', $header_featured),
			str_replace('%section%', 'club', $header_background),
			str_replace('%section%', 'club', $header_parallax),
			str_replace('%section%', 'club', $header_overlay_color),
			str_replace('%section%', 'club', $header_overlay_color_alpha),
			str_replace('%section%', 'club', $header_scroll_opacity),
			str_replace('%section%', 'club', $header_scrolldown),

			str_replace('%section%', 'club', $body_section_title),
			str_replace('%section%', 'club', $body_layout_width),
			str_replace('%section%', 'club', $body_layout_width_custom),
			str_replace('%section%', 'club', $show_breadcrumb),
			str_replace('%section%', 'club', $breadcrumb_align),
			str_replace('%section%', 'club', $show_title),
			str_replace('%section%', 'club', $show_media),
			str_replace('%section%', 'club', $show_comments),
			str_replace('%section%', 'club', $show_share),
			str_replace('%section%', 'club', $show_tags),
			str_replace('%section%', 'club', $show_tags_align),
			str_replace('%section%', 'club', $sidebar_section_title),
			str_replace('%section%', 'club', run_array_to($sidebar_activate, 'std', 'on')),
			str_replace('%section%', 'club', $sidebar_widget),
			str_replace('%section%', 'club', $sidebar_position),
			str_replace('%section%', 'club', $sidebar_size),
			str_replace('%section%', 'club', $sidebar_sticky),
			str_replace('%section%', 'club', $sidebar_style),
			str_replace('%section%', 'club', $sidebar_bgcolor),
			str_replace('%section%', 'club', $sidebar_fill),

			str_replace('%section%', 'club', $navigation_section_title),
			str_replace('%section%', 'club', $navigation_activate),
			str_replace('%section%', 'club', $navigation_page_index),
			str_replace('%section%', 'club', $navigation_index_label),
			str_replace('%section%', 'club', $navigation_nextprev_title),
			str_replace('%section%', 'club', $footer_section_title),
			str_replace('%section%', 'club', $footer_uncode_block),
			str_replace('%section%', 'club', $footer_width),

			///////////////
			/// Event
			///////////////
			str_replace('%section%', 'tribe_events', $menu_section_title),
			str_replace('%section%', 'tribe_events', $menu),
			str_replace('%section%', 'tribe_events', $menu_width),
			str_replace('%section%', 'tribe_events', $menu_opaque),
			str_replace('%section%', 'tribe_events', $header_section_title),
			str_replace('%section%', 'tribe_events', run_array_to($header_type, 'std', 'header_basic')),
			str_replace('%section%', 'tribe_events', $header_uncode_block),
			str_replace('%section%', 'tribe_events', $header_revslider),
			str_replace('%section%', 'tribe_events', $header_layerslider),

			str_replace('%section%', 'tribe_events', $header_width),
			str_replace('%section%', 'tribe_events', $header_height),
			str_replace('%section%', 'tribe_events', $header_min_height),
			str_replace('%section%', 'tribe_events', $header_title),
			str_replace('%section%', 'tribe_events', $header_style),
			str_replace('%section%', 'tribe_events', $header_content_width),
			str_replace('%section%', 'tribe_events', $header_custom_width),
			str_replace('%section%', 'tribe_events', $header_align),
			str_replace('%section%', 'tribe_events', $header_position),
			str_replace('%section%', 'tribe_events', $header_title_font),
			str_replace('%section%', 'tribe_events', $header_title_size),
			str_replace('%section%', 'tribe_events', $header_title_height),
			str_replace('%section%', 'tribe_events', $header_title_spacing),
			str_replace('%section%', 'tribe_events', $header_title_weight),
			str_replace('%section%', 'tribe_events', $header_title_transform),
			str_replace('%section%', 'tribe_events', $header_title_italic),
			str_replace('%section%', 'tribe_events', $header_text_animation),
			str_replace('%section%', 'tribe_events', $header_animation_speed),
			str_replace('%section%', 'tribe_events', $header_animation_delay),
			str_replace('%section%', 'tribe_events', $header_featured),
			str_replace('%section%', 'tribe_events', $header_background),
			str_replace('%section%', 'tribe_events', $header_parallax),
			str_replace('%section%', 'tribe_events', $header_overlay_color),
			str_replace('%section%', 'tribe_events', $header_overlay_color_alpha),
			str_replace('%section%', 'tribe_events', $header_scroll_opacity),
			str_replace('%section%', 'tribe_events', $header_scrolldown),

			str_replace('%section%', 'tribe_events', $body_section_title),
			str_replace('%section%', 'tribe_events', $body_layout_width),
			str_replace('%section%', 'tribe_events', $body_layout_width_custom),
			str_replace('%section%', 'tribe_events', $show_breadcrumb),
			str_replace('%section%', 'tribe_events', $breadcrumb_align),
			str_replace('%section%', 'tribe_events', $show_title),
			str_replace('%section%', 'tribe_events', $show_media),
			str_replace('%section%', 'tribe_events', $show_comments),
			str_replace('%section%', 'tribe_events', $show_share),
			str_replace('%section%', 'tribe_events', $show_tags),
			str_replace('%section%', 'tribe_events', $show_tags_align),
			str_replace('%section%', 'tribe_events', $sidebar_section_title),
			str_replace('%section%', 'tribe_events', run_array_to($sidebar_activate, 'std', 'on')),
			str_replace('%section%', 'tribe_events', $sidebar_widget),
			str_replace('%section%', 'tribe_events', $sidebar_position),
			str_replace('%section%', 'tribe_events', $sidebar_size),
			str_replace('%section%', 'tribe_events', $sidebar_sticky),
			str_replace('%section%', 'tribe_events', $sidebar_style),
			str_replace('%section%', 'tribe_events', $sidebar_bgcolor),
			str_replace('%section%', 'tribe_events', $sidebar_fill),

			str_replace('%section%', 'tribe_events', $navigation_section_title),
			str_replace('%section%', 'tribe_events', $navigation_activate),
			str_replace('%section%', 'tribe_events', $navigation_page_index),
			str_replace('%section%', 'tribe_events', $navigation_index_label),
			str_replace('%section%', 'tribe_events', $navigation_nextprev_title),
			str_replace('%section%', 'tribe_events', $footer_section_title),
			str_replace('%section%', 'tribe_events', $footer_uncode_block),
			str_replace('%section%', 'tribe_events', $footer_width),
			...
			//  Clubs Index		///
			//////////////////////
			str_replace('%section%', 'club_index', $menu_section_title),
			str_replace('%section%', 'club_index', $menu),
			str_replace('%section%', 'club_index', $menu_width),
			str_replace('%section%', 'club_index', $menu_opaque),
			str_replace('%section%', 'club_index', $header_section_title),
			str_replace('%section%', 'club_index', run_array_to($header_type, 'std', 'header_basic')),
			str_replace('%section%', 'club_index', $header_uncode_block),
			str_replace('%section%', 'club_index', $header_revslider),
			str_replace('%section%', 'club_index', $header_layerslider),

			str_replace('%section%', 'club_index', $header_width),
			str_replace('%section%', 'club_index', $header_height),
			str_replace('%section%', 'club_index', $header_min_height),
			str_replace('%section%', 'club_index', $header_title),
			str_replace('%section%', 'club_index', $header_style),
			str_replace('%section%', 'club_index', $header_content_width),
			str_replace('%section%', 'club_index', $header_custom_width),
			str_replace('%section%', 'club_index', $header_align),
			str_replace('%section%', 'club_index', $header_position),
			str_replace('%section%', 'club_index', $header_title_font),
			str_replace('%section%', 'club_index', $header_title_size),
			str_replace('%section%', 'club_index', $header_title_height),
			str_replace('%section%', 'club_index', $header_title_spacing),
			str_replace('%section%', 'club_index', $header_title_weight),
			str_replace('%section%', 'club_index', $header_title_transform),
			str_replace('%section%', 'club_index', $header_title_italic),
			str_replace('%section%', 'club_index', $header_text_animation),
			str_replace('%section%', 'club_index', $header_animation_speed),
			str_replace('%section%', 'club_index', $header_animation_delay),
			str_replace('%section%', 'club_index', $header_featured),
			str_replace('%section%', 'club_index', $header_background),
			str_replace('%section%', 'club_index', $header_parallax),
			str_replace('%section%', 'club_index', $header_overlay_color),
			str_replace('%section%', 'club_index', $header_overlay_color_alpha),
			str_replace('%section%', 'club_index', $header_scroll_opacity),
			str_replace('%section%', 'club_index', $header_scrolldown),

			str_replace('%section%', 'club_index', $body_section_title),
			str_replace('%section%', 'club_index', $show_breadcrumb),
			str_replace('%section%', 'club_index', $breadcrumb_align),
			str_replace('%section%', 'club_index', $body_uncode_block),
			str_replace('%section%', 'club_index', run_array_to($body_layout_width, 'condition', '_uncode_%section%_content_block:is(),_uncode_%section%_content_block:is(none)')),
			str_replace('%section%', 'club_index', $body_single_post_width),
			str_replace('%section%', 'club_index', $body_single_text_lenght),
			str_replace('%section%', 'club_index', $show_title),
			str_replace('%section%', 'club_index', $sidebar_section_title),
			str_replace('%section%', 'club_index', run_array_to($sidebar_activate, 'std', 'on')),
			str_replace('%section%', 'club_index', $sidebar_widget),
			str_replace('%section%', 'club_index', $sidebar_position),
			str_replace('%section%', 'club_index', $sidebar_size),
			str_replace('%section%', 'club_index', $sidebar_sticky),
			str_replace('%section%', 'club_index', $sidebar_style),
			str_replace('%section%', 'club_index', $sidebar_bgcolor),
			str_replace('%section%', 'club_index', $sidebar_fill),
			str_replace('%section%', 'club_index', $footer_section_title),
			str_replace('%section%', 'club_index', $footer_uncode_block),
			str_replace('%section%', 'club_index', $footer_width),
			...
			//  Events Index   ///
			//////////////////////
			str_replace('%section%', 'tribe_events_index', $menu_section_title),
			str_replace('%section%', 'tribe_events_index', $menu),
			str_replace('%section%', 'tribe_events_index', $menu_width),
			str_replace('%section%', 'tribe_events_index', $menu_opaque),
			str_replace('%section%', 'tribe_events_index', $header_section_title),
			str_replace('%section%', 'tribe_events_index', run_array_to($header_type, 'std', 'header_basic')),
			str_replace('%section%', 'tribe_events_index', $header_uncode_block),
			str_replace('%section%', 'tribe_events_index', $header_revslider),
			str_replace('%section%', 'tribe_events_index', $header_layerslider),

			str_replace('%section%', 'tribe_events_index', $header_width),
			str_replace('%section%', 'tribe_events_index', $header_height),
			str_replace('%section%', 'tribe_events_index', $header_min_height),
			str_replace('%section%', 'tribe_events_index', $header_title),
			str_replace('%section%', 'tribe_events_index', $header_title_text),
			str_replace('%section%', 'tribe_events_index', $header_style),
			str_replace('%section%', 'tribe_events_index', $header_content_width),
			str_replace('%section%', 'tribe_events_index', $header_custom_width),
			str_replace('%section%', 'tribe_events_index', $header_align),
			str_replace('%section%', 'tribe_events_index', $header_position),
			str_replace('%section%', 'tribe_events_index', $header_title_font),
			str_replace('%section%', 'tribe_events_index', $header_title_size),
			str_replace('%section%', 'tribe_events_index', $header_title_height),
			str_replace('%section%', 'tribe_events_index', $header_title_spacing),
			str_replace('%section%', 'tribe_events_index', $header_title_weight),
			str_replace('%section%', 'tribe_events_index', $header_title_transform),
			str_replace('%section%', 'tribe_events_index', $header_title_italic),
			str_replace('%section%', 'tribe_events_index', $header_text_animation),
			str_replace('%section%', 'tribe_events_index', $header_animation_speed),
			str_replace('%section%', 'tribe_events_index', $header_animation_delay),
			str_replace('%section%', 'tribe_events_index', $header_featured),
			str_replace('%section%', 'tribe_events_index', $header_background),
			str_replace('%section%', 'tribe_events_index', $header_parallax),
			str_replace('%section%', 'tribe_events_index', $header_overlay_color),
			str_replace('%section%', 'tribe_events_index', $header_overlay_color_alpha),
			str_replace('%section%', 'tribe_events_index', $header_scroll_opacity),
			str_replace('%section%', 'tribe_events_index', $header_scrolldown),

			str_replace('%section%', 'tribe_events_index', $body_section_title),
			str_replace('%section%', 'tribe_events_index', $show_breadcrumb),
			str_replace('%section%', 'tribe_events_index', $breadcrumb_align),
			// str_replace('%section%', 'tribe_events_index', $body_uncode_block),
			// str_replace('%section%', 'tribe_events_index', run_array_to($body_layout_width, 'condition', '_uncode_%section%_content_block:is(),_uncode_%section%_content_block:is(none)')),
			// str_replace('%section%', 'tribe_events_index', $body_single_post_width),
			// str_replace('%section%', 'tribe_events_index', $body_single_text_lenght),
			str_replace('%section%', 'tribe_events_index', $show_title),
			str_replace('%section%', 'tribe_events_index', $sidebar_section_title),
			str_replace('%section%', 'tribe_events_index', run_array_to($sidebar_activate, 'std', 'on')),
			str_replace('%section%', 'tribe_events_index', $sidebar_widget),
			str_replace('%section%', 'tribe_events_index', $sidebar_position),
			str_replace('%section%', 'tribe_events_index', $sidebar_size),
			str_replace('%section%', 'tribe_events_index', $sidebar_sticky),
			str_replace('%section%', 'tribe_events_index', $sidebar_style),
			str_replace('%section%', 'tribe_events_index', $sidebar_bgcolor),
			str_replace('%section%', 'tribe_events_index', $sidebar_fill),
			str_replace('%section%', 'tribe_events_index', $footer_section_title),
			str_replace('%section%', 'tribe_events_index', $footer_uncode_block),
			str_replace('%section%', 'tribe_events_index', $footer_width),
			...
			array(
				'id' => '_uncode_notification',
				'label' => esc_html__('Show notification', 'uncode') ,
				'desc' => esc_html__('Set to off will diable notification on the site.', 'uncode'),
				'type' => 'on-off',
				'section' => 'uncode_notification_section',
				'std' => 'on'
			),
			array(
				'id' => '_uncode_notification_mobile',
				'label' => esc_html__('Show notification on mobile', 'uncode') ,
				'desc' => esc_html__('Set to off will diable notification on screen below 768px.', 'uncode'),
				'type' => 'on-off',
				'section' => 'uncode_notification_section',
				'std' => 'off'
			),
			array(
				'id' => '_uncode_notification_max',
				'label' => esc_html__('Max notification number', 'uncode') ,
				'desc' => esc_html__('Too many notification will break the page.', 'uncode') ,
				'type' => 'select',
				'section' => 'uncode_notification_section',
				'std' => 3,
				'choices' => array(
			...
			array(
				'id' => '_uncode_notification_delay',
				'label' => esc_html__('notification delay in ms', 'uncode') ,
				'desc' => esc_html__('Delay before alert auto-dismisses (optional). Set to 0 for persistence.', 'uncode') ,
				'type' => 'select',
				'section' => 'uncode_notification_section',
				'std' => 5000,
				'choices' => array(
			...
			array(
				'id' => '_uncode_notification_placement_x',
				'label' => esc_html__('Notification Horizontal placement', 'uncode') ,
				'type' => 'select',
				'section' => 'uncode_notification_section',
				'std' => 'right',
				'choices' => array(
			...
			array(
				'id' => '_uncode_notification_placement_y',
				'label' => esc_html__('Notification Vertical placement', 'uncode') ,
				'type' => 'select',
				'section' => 'uncode_notification_section',
				'std' => 'bottom',
				'choices' => array(
			...
			array(
				'id' => '_uncode_notification_offset_x',
				'label' => esc_html__('Notification offset x', 'uncode') ,
				'desc' => esc_html__('Horizontal offset from edge of window <b>px</b>.', 'uncode') ,
				'std' => '20',
				'type' => 'text',
				'section' => 'uncode_notification_section',
			) ,
			array(
				'id' => '_uncode_notification_offset_y',
				'label' => esc_html__('Notification offset y', 'uncode') ,
				'desc' => esc_html__('Vertical offset from edge of window <b>px</b>.', 'uncode') ,
				'std' => '20',
				'type' => 'text',
				'section' => 'uncode_notification_section',
			) ,
			array(
				'id' => '_uncode_notification_spacing',
				'label' => esc_html__('Spacing between notifications', 'uncode') ,
				'desc' => esc_html__('px value.', 'uncode') ,
				'std' => '20',
				'type' => 'text',
				'section' => 'uncode_notification_section',
			) ,
			...
			array(
				'id' => '_uncode_body_font_family_zh',
				'label' => esc_html__('Body font family zh', 'uncode') ,
				'desc' => esc_html__('Specify the body font family zh lang.', 'uncode') ,
				'std' => $zh_fonts_std,
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				'id' => '_uncode_ui_font_family_zh',
				'label' => esc_html__('UI font family zh', 'uncode') ,
				'desc' => esc_html__('Specify the UI font family for zh lang.', 'uncode') ,
				'std' => $zh_fonts_std,
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				'id' => '_uncode_heading_font_family_zh',
				'label' => esc_html__('Headings font family zh', 'uncode') ,
				'desc' => esc_html__('Specify the headings font family for zh lang.', 'uncode') ,
				'std' => $zh_fonts_std,
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				'id' => '_uncode_topbar_block_title',
				'label' => '<i class="fa fa-bookmark"></i> ' . esc_html__('Topbar', 'uncode') ,
				'type' => 'textblock-titled',
				'class' => 'section-title',
				'section' => 'uncode_customize_section',
			) ,
			array(
				'id' => '_uncode_topbar_bg_color',
				'label' => esc_html__('Topbar Background color', 'uncode') ,
				'desc' => esc_html__('Specify the topbar background color.', 'uncode') ,
				'std' => 'color-vyce',
				'type' => 'uncode_color',
				'section' => 'uncode_customize_section',
			) ,
			array(
				'id' => '_uncode_topbar_color',
				'label' => esc_html__('Topbar font color', 'uncode') ,
				'desc' => esc_html__('Specify the topbar font color.', 'uncode') ,
				'std' => 'color-lxmt',
				'type' => 'uncode_color',
				'section' => 'uncode_customize_section',
			) ,
			array(
				'id' => '_uncode_topbar_font_size',
				'label' => esc_html__('Topbar font size', 'uncode') ,
				'desc' => esc_html__('Specify the topbar font size.', 'uncode') ,
				'std' => '11',
				'type' => 'text',
				'section' => 'uncode_customize_section',
			) ,
			array(
				...
				'label' => esc_html__('Topbar font family', 'uncode') ,
				'desc' => esc_html__('Specify the topbar font family.', 'uncode') ,
				'std' => 'font-762333',
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				'id' => '_uncode_topbar_font_family_zh',
				'label' => esc_html__('Topbar font family zh', 'uncode') ,
				'desc' => esc_html__('Specify the topbar font family for zh lang.', 'uncode') ,
				'std' => $zh_fonts_std,
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				...
				'label' => esc_html__('Topbar font weight', 'uncode') ,
				'desc' => esc_html__('Specify the topbar font weight.', 'uncode') ,
				'std' => '400',
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				'id' => '_uncode_menu_font_family_zh',
				'label' => esc_html__('Menu font family zh', 'uncode') ,
				'desc' => esc_html__('Specify the menu font family for zh lang.', 'uncode') ,
				'std' => $zh_fonts_std,
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
			...
			array(
				'id' => '_uncode_buttons_font_family_zh',
				'label' => esc_html__('Buttons font family zh', 'uncode') ,
				'desc' => esc_html__('Specify the buttons font family for zh lang.', 'uncode') ,
				'std' => $zh_fonts_std,
				'type' => 'select',
				'section' => 'uncode_customize_section',
				'operator' => 'or',
